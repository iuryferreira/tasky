...
{
    public BeginCommand(IMediator mediator, IConsoleWriter writer, INotifier notifier) : base(mediator, writer, notifier)
    {
    }
    ...
    public sealed class Settings : CommandSettings
    {
        ...
        public const string CommandDescription = "Marks a task/step already created as begin informing the id and board";
